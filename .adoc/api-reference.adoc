...
[[_overwrite]]
==== Create or update a new repository
....
...
===== Description
If repository with specified code exists, first delete it. If branch is specified and does not exist, will create it.
...
|**dateValue** +
__optional__|Date value|string (date-time)
|**longValue** +
...
|**lastMeasureDate** +
__optional__|The last measure date|string (date-time)
|**codeOnly** +
__optional__||boolean
|===
