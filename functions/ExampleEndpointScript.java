...
public class ExampleEndpointScript extends EndpointScript {

    private static final Logger LOG = LoggerFactory.getLogger(EndpointScript.class);
    ...
    public void execute(Map<String, Object> parameters) throws BusinessException {
        ...
        try {
            ...
            String remainingPath = this.endpointRequest.getRemainingPath(); // Retrieve the remaining path after endpoint access path
            String contentTypeHeader = this.endpointRequest.getHeader("Content-Type"); // Get any header
            String acceptedLanguages = String.valueOf(this.endpointRequest.getHeaders("Accepted-Language")); // Headers can also be multivalued
            ...
            throw new BusinessException("Encountered error: " + e.getMessage(), e);
        }
    }
